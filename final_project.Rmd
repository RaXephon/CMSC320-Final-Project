...
fiji_map <- leaflet(quakes) %>%
  ...
  addAwesomeMarkers(lng = 178.0650, lat = -17.7134, icon = icons)
...
TODO: 
1. get max/min of lat, log to split the region into four. (sector 1 - 4)
2. hypothesis (mag sec1 = sec2 = sec3 = sec4)
3. ANOVA test to see the means of four regions' mag are the same 
