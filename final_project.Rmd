...
corr_spring <- cor(ext_dat$depth, ext_dat$spring)
corr_summer <- cor(ext_dat$depth, ext_dat$summer)
corr_fall <- cor(ext_dat$depth, ext_dat$fall)
corr_winter <- cor(ext_dat$depth, ext_dat$winter)
